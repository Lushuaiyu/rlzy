...
CREATE TABLE `attention` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '关注表',
  ...
  `type` int(11) DEFAULT NULL COMMENT '1为报名表 0为招聘表(简章表)',
  `status` int(11) DEFAULT '0' COMMENT '关注状态 0 待关注 1已关注 2取消关注 ',
  `createTime` datetime DEFAULT NULL,
  `modifyTime` datetime DEFAULT NULL COMMENT '取消关注的时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `attention` VALUES (1,2,4,1,1,0,'2018-11-20 16:26:54','2019-07-31 06:39:11'),(2,4,3,1,1,0,'2018-11-20 16:27:18','2019-07-31 10:39:13'),(3,3,1,2,1,2,'2018-11-20 16:52:37','2019-07-14 06:39:17'),(4,1,2,3,1,0,'2018-11-20 16:52:49','2019-07-25 06:39:21'),(5,5,5,1,0,2,'2019-07-31 10:18:03','2019-07-11 06:39:25'),(7,6,6,4,0,0,'2019-07-31 11:51:36','2019-07-10 06:39:28'),(8,7,7,4,1,0,'2019-07-31 11:57:38','2019-07-14 06:39:32'),(9,8,9,4,0,0,'2019-07-31 11:57:53','2019-07-18 06:39:37');
...
--
-- Table structure for table `entry_resignation`
--

DROP TABLE IF EXISTS `entry_resignation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `entry_resignation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `rebate_male_entry` decimal(10,0) DEFAULT '0' COMMENT '返佣男',
  `rebate_female_entry` decimal(10,0) DEFAULT '0' COMMENT '返佣女',
  `rebate_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '返佣时间',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `delete_flag` int(11) DEFAULT '0' COMMENT '是否删除 0 未删除 1 已删除',
  `brief_chapter_id` int(11) DEFAULT NULL COMMENT '简章id',
  `type` int(11) DEFAULT NULL COMMENT '0 面试返佣 1 报道返佣 2 入职返佣',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='发布简章时的返佣';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `entry_resignation`
--

LOCK TABLES `entry_resignation` WRITE;
/*!40000 ALTER TABLE `entry_resignation` DISABLE KEYS */;
INSERT INTO `entry_resignation` VALUES (1,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,1,0),(2,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,2,1),(3,200,400,'2019-08-28 06:51:05','2019-08-26 16:00:00',0,3,2),(4,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,4,0),(5,200,400,'2019-08-28 06:33:15','2019-08-26 16:00:00',0,1,2),(6,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,6,0),(7,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,7,0),(8,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,8,1),(9,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,9,2),(10,100,200,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,11,2),(11,200,300,'2019-08-26 16:00:00','2019-08-26 16:00:00',0,2,2),(12,122,252,'2019-08-28 11:36:26','2019-08-28 11:37:02',0,3,2),(13,456,215,'2019-08-28 11:36:26','2019-08-28 11:37:02',0,8,2),(14,412,789,'2019-08-28 11:36:26','2019-08-28 11:37:03',0,5,0),(15,749,954,'2019-08-28 11:36:26','2019-08-28 11:37:04',0,7,0);
/*!40000 ALTER TABLE `entry_resignation` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `hr_acct` (
  ...
  `already_consumed` decimal(10,0) DEFAULT NULL COMMENT '已消费',
...
INSERT INTO `hr_acct` VALUES (1,2,12608.00,100.00,100,'2019-08-27 03:32:56','2019-10-29 09:44:03',NULL),(2,3,12608.00,200.00,200,'2019-08-27 03:32:56','2018-10-29 09:44:05',NULL),(3,4,12718.00,0.00,300,'2019-08-27 03:32:56','2018-10-30 09:10:33',NULL),(4,7,12608.00,700.00,100,'2019-08-27 03:32:56','2019-01-10 02:27:55',NULL),(5,8,14962.00,446.00,400,'2019-08-28 12:56:19','2019-01-10 02:27:56',NULL),(7,9,12608.00,0.00,500,'2019-08-28 08:36:33','2019-08-27 18:32:40',NULL),(8,10,12608.00,0.00,200,'2019-08-28 08:36:33','2019-08-27 18:32:40',1);
...
CREATE TABLE `hr_acct_detail` (
  ...
  `type` int(255) DEFAULT NULL COMMENT '0 充值（收入） 1发布简章扣款（支出） 2简章返佣获得（收入） 3提现（支出） 4修改简章扣款（支出） 5冻结金额退回（收入）',
  ...
  `signUpId` int(11) DEFAULT NULL COMMENT '返佣的投递表id',
  `briefChapterId` int(11) DEFAULT NULL COMMENT '发布或者编辑简章的简章id',
  PRIMARY KEY (`id`)
...
INSERT INTO `hr_acct_detail` VALUES (1,1,200,1100,900,'2018-10-31 00:00:00',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,2,300,2200,1900,'2019-07-30 10:32:25',NULL,NULL,0,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,3,200,200,200,'2018-10-14 00:00:00',NULL,NULL,0,1,NULL,NULL,NULL,NULL,NULL,2,NULL),(4,3,300,200,200,'2018-11-14 00:00:00',NULL,NULL,0,1,NULL,NULL,NULL,NULL,NULL,2,NULL),(5,3,400,200,200,'2018-11-14 00:00:00',NULL,NULL,1,2,NULL,NULL,NULL,NULL,NULL,2,NULL),(6,3,400,200,200,'2018-11-14 00:00:00',NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,3,400,200,200,'2018-11-14 00:00:00',NULL,NULL,1,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,3,100,1000,1100,'2018-11-15 00:00:00',NULL,0,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,3,25,NULL,NULL,'2018-11-15 00:00:00',NULL,2,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,3,400,200,200,'2018-11-15 00:00:00',NULL,2,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(11,3,400,200,200,'2018-11-15 00:00:00',NULL,2,2,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(14,3,1000,NULL,NULL,'2018-11-16 00:00:00',0,NULL,0,3,'15750852005',1,NULL,NULL,NULL,NULL,NULL),(15,3,1500,NULL,NULL,'2018-11-19 00:00:00',1,NULL,0,3,NULL,2,NULL,NULL,NULL,NULL,NULL),(16,3,1500,NULL,NULL,'2018-11-19 00:00:00',1,NULL,0,3,NULL,2,NULL,NULL,'11111',NULL,NULL),(17,1,100,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL),(18,1,100,NULL,NULL,'2019-07-17 00:00:00',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL),(19,2,100,NULL,NULL,'2019-07-17 00:00:00',NULL,NULL,0,2,NULL,NULL,NULL,NULL,NULL,1,NULL);
...
CREATE TABLE `hr_briefchapter` (
  ...
  `avgSalary` decimal(10,0) DEFAULT '0' COMMENT '综合工资',
  `detailSalary` decimal(10,0) DEFAULT NULL COMMENT '结算工资',
  `detailSalaryWay` int(11) DEFAULT NULL COMMENT '结算工资方式',
  `educationId` varchar(255) DEFAULT NULL COMMENT '学历',
  `experienceId` int(11) DEFAULT NULL COMMENT '经验',
  `welfareId` varchar(255) DEFAULT NULL COMMENT '福利',
  `PostDetail` varchar(255) DEFAULT NULL COMMENT '职位描述',
  `registerTime` date DEFAULT NULL COMMENT '报道时间',
  `contractWay` int(11) DEFAULT NULL COMMENT '合同签订方 0招聘单位 1用工单位 2厂方指定劳务公司',
  `contract_way_detail_id` int(11) DEFAULT NULL COMMENT '合同签订方详情id(用工方式\n)',
  `contractTime` datetime DEFAULT NULL COMMENT '合同到期时间',
  ...
  `work_time_arrange_id` int(11) DEFAULT NULL COMMENT '工作时间安排',
  `clothing_requirement_id` int(11) DEFAULT NULL COMMENT '服装要求',
  ...
  `rebate_male_interview` decimal(10,0) DEFAULT '0' COMMENT '返佣金额男面试',
  `rebate_female_interview` decimal(10,0) DEFAULT '0' COMMENT '返佣金额女面试',
  `rebate_male_report` decimal(10,0) DEFAULT '0' COMMENT '返佣金额男报道',
  `rebate_female_report` decimal(10,0) DEFAULT '0' COMMENT '返佣金额女报道',
  `rebate_male_entry` decimal(10,0) DEFAULT '0' COMMENT '返佣金额男入职',
  `rebate_female_entry` decimal(10,0) DEFAULT '0' COMMENT '返佣金额女入职',
  PRIMARY KEY (`Id`)
...
INSERT INTO `hr_briefchapter` VALUES (1,5,1,4,21000,300,2,'1',1,'3','bbb','2019-07-19',1,1,'2019-11-17 16:48:10',0,1,8,1,NULL,NULL,20,'2018-12-19 13:40:24',1,2,1,1,1,'1',1,NULL,0,NULL,10,22,'归一道','你好街',1,'aaaa','2019-05-07 00:00:00','2019-07-09 10:00:00',0,200,400,522,545,854,102),(2,4,2,2,12000,20,2,'1,2',2,'1,2,3,4','cccc','2019-07-22',1,2,'2019-08-02 16:48:20',0,1,8,1,NULL,'2019-08-26 17:46:32',21,'2018-12-19 13:45:57',2,3,2,2,2,'2',2,'https://szsahsh.oss-cn-shanghai.aliyuncs.com/upload/shop/ahsh_20190723144327.jpg',1,NULL,23,12,'举头路','llfasdf街',1,'eeeee','2019-07-22 00:00:00','2019-05-15 14:00:00',0,500,700,255,223,895,154),(3,3,3,0,13000,300,3,'2',3,'4','dddd','2019-07-25',1,3,'2020-12-17 16:48:50',1,1,7,1,NULL,NULL,56,'2018-12-19 13:47:13',3,4,2,1,3,'3',3,NULL,1,NULL,12,25,'喵喵路','按说大道',1,'iiiiii','2019-07-14 00:00:00','2019-07-26 10:00:00',0,260,500,426,456,896,452),(4,2,1,10,8000,20,2,'3',3,'3,4','miaomiao','2019-07-21',0,2,'2019-12-08 16:48:24',1,0,8,1,NULL,NULL,56,'2018-12-19 14:04:38',3,2,2,1,4,'2',2,NULL,0,NULL,10,23,'陵城路','皈依路',1,'安静路','2019-07-07 00:00:00','2019-07-17 09:00:00',0,700,1100,422,712,1196,755),(5,8,2,12,2000,300,3,'2',4,'3','aaa','2019-09-21',0,3,'2019-08-03 16:48:20',1,1,8,1,NULL,NULL,54,'2018-12-19 14:05:31',2,4,1,2,2,'3',1,NULL,0,NULL,16,74,'移动公司','安创路',1,'静安寺','2019-07-07 00:00:00','2017-08-10 13:00:00',0,720,900,632,782,896,457),(6,14,3,10,15000,20,2,'1',5,'3,4','eeeee','2019-08-28',1,3,'2019-07-17 16:48:13',0,0,8,1,NULL,NULL,67,'2018-12-19 14:40:05',2,2,2,1,1,'5',3,NULL,1,NULL,18,54,'电力大厦','仁和路',1,'永乐路','2019-07-21 00:00:00','2019-08-14 15:00:00',0,400,400,524,249,865,412),(7,6,2,18,0,6000,3,'1',1,'3','ffffff','2019-08-19',0,2,'2021-12-17 16:48:45',1,1,9,1,NULL,NULL,76,'2018-12-19 14:44:01',4,1,3,4,3,'3',3,NULL,1,NULL,29,21,'武陵路','康庄路',1,'常州街','2019-07-20 00:00:00','2019-08-13 11:00:00',0,800,100,544,472,457,423),(8,4,3,10,400,800,2,'1',5,'3,4','synh','2019-08-19',1,2,'2019-08-19 04:33:57',1,1,9,1,NULL,NULL,10,'2019-08-19 04:34:24',4,2,3,1,3,'4',1,NULL,1,NULL,16,21,'qwe','zxc',1,'vvv','2019-08-19 04:35:15','2019-08-19 04:35:17',0,400,731,521,954,741,422),(9,7,3,12,1000,100,1,'2',1,'1,2','miao','2019-08-19',1,2,'2019-08-19 05:46:34',0,1,8,1,NULL,NULL,10,'2019-08-19 05:47:17',3,1,2,1,2,'3',2,NULL,1,NULL,28,30,'zghqorh','vbf',1,'无穷路','2019-08-19 05:48:20','2019-08-19 05:48:24',0,800,475,641,145,152,715),(11,3,2,4,10000,100,2,'3',2,'1,3','这个职位十分的适合你么','2019-08-24',0,2,'2019-08-24 11:30:42',0,1,7,1,NULL,NULL,0,NULL,1,2,1,1,2,'2',3,'fdfsdaf',0,'fsdfdfdf',10,20,'香榭街道','miao streat',3,'wang streat','2019-08-26 01:32:50','2019-08-24 11:30:42',0,100,52,400,552,123,523);
...
--
-- Table structure for table `hr_dictionary`
--
...
--
-- Dumping data for table `hr_dictionary`
--

LOCK TABLES `hr_dictionary` WRITE;
/*!40000 ALTER TABLE `hr_dictionary` DISABLE KEYS */;
INSERT INTO `hr_dictionary` VALUES (1,'岗位',1),(2,'学历',1),(3,'专业',1),(4,'与被推介人关系',1),(5,'招聘男生年龄范围',1),(9,'招聘女生年龄范围',1),(10,'福利',1),(12,'经验要求',1),(13,'用工形式',1),(14,'服装要求',1),(15,'兴趣爱好',1),(16,'工作方式',1),(17,'工作时间安排',1),(18,'加班时长',1),(19,'用人单位地址',1),(20,'非用人单位地址',1),(21,'男生的招聘数量',1),(22,'女人的招聘数量',1),(23,'工资结算形式',1),(24,'投诉类型',1),(25,'投诉状态',1);
/*!40000 ALTER TABLE `hr_dictionary` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hr_dictionary_item`
--

DROP TABLE IF EXISTS `hr_dictionary_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hr_dictionary_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '数据字典项表',
  `pId` int(11) DEFAULT NULL COMMENT '字典表Id',
  `name` varchar(255) DEFAULT NULL COMMENT '显示名',
...
--
-- Dumping data for table `hr_dictionary_item`
--
...
CREATE TABLE `hr_group` (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '组织表',
  `CertifierId` int(11) DEFAULT NULL COMMENT '提交认证人Id(userId)',
  ...
  `GroupAddress` varchar(255) DEFAULT NULL COMMENT '公司地址',
  `BusinessLicense` varchar(255) DEFAULT NULL COMMENT '营业执照',
  `HelpProve` varchar(255) DEFAULT NULL COMMENT '代招证明',
...
INSERT INTO `hr_group` VALUES (1,8,'苏州永拓人力资源有限公司','公司简介','法人','123','问津路','苏州市吴中区星湖街328号','营业执照a','123',NULL,2,1,'2019-01-10 15:46:03','2019-08-27 22:20:41',NULL,'100-500','股份制',NULL,NULL,0,0),(2,8,'佳能苏州电子厂','公司简介','法人',NULL,NULL,'苏州市吴中区星湖街328号','营业执照b',NULL,NULL,2,0,'2019-01-10 15:46:06','2019-08-27 22:20:41',1,'20-99','股份制',NULL,NULL,1,0),(3,7,'华硕苏州电子厂','公司简介','法人','3333','天堂','苏州市吴中区星湖街328号','营业执照c',NULL,'',2,2,'2019-01-10 15:46:07','2019-08-27 22:20:41',1,'20-99','股份制',NULL,NULL,1,0),(4,8,'兴华科技','企业简介','法人','123','问津路','龙泉路','营业执照d','',NULL,2,1,'2019-01-10 15:46:22','2019-08-27 22:20:41',1,'100-500','股份制',NULL,NULL,1,0),(5,8,'喵喵厂','公司简介','喵星人','123','漕宝路','龙泉大道','营业执照e',NULL,NULL,2,1,'2019-06-26 04:00:37','2019-08-27 22:20:41',1,'200-300','股份制',NULL,NULL,1,0),(6,9,'喵喵公司','这个公司很厉害的','ddd','ttt','路','aa街道','urlddd',NULL,NULL,2,0,'2019-08-03 02:06:02','2019-08-27 22:20:41',1,'100-300','股份制',NULL,NULL,1,0),(7,6,'任天堂','这个公司','ddx','ttc','路在何方','水电费第三方','xzgdg',NULL,NULL,2,0,'2019-08-04 02:19:02','2019-08-27 22:20:41',13,'200-600','股份制',NULL,NULL,NULL,0),(8,10,'人天公司','这个公司不不不','fvd','dvnb','路在何方sdafsd','水电费第三方khk','gfhhg',NULL,NULL,2,0,'2019-08-04 02:20:16','2019-08-27 22:20:41',NULL,'100-420','股份制',NULL,NULL,NULL,0),(9,11,'企业','公司简介','法人','123','淘宝路','苏州市相城区','地方大豆腐','水电费',NULL,2,1,'2019-08-04 02:21:27','2019-08-27 22:20:41',NULL,NULL,'私有制',NULL,NULL,NULL,0),(10,12,'公司','公司简介','法人','123afd','啦啦噜','苏州市虎丘区','ffadsgg','qwetr',NULL,2,0,'2019-08-04 02:21:38','2019-08-27 22:20:41',NULL,'200-800','公有制',NULL,NULL,NULL,0),(11,13,'招财公司','jhj','法人','ertert',NULL,'khjk','wewew',NULL,NULL,2,0,'2019-08-23 01:54:13','2019-08-27 22:20:41',1,NULL,'股份制',NULL,NULL,NULL,0),(12,4,'神奇公司','hjkh','法人','gf',NULL,'jlhk','sdsdsd',NULL,NULL,2,0,'2019-08-23 01:54:12','2019-08-27 22:20:41',1,NULL,'股份制',NULL,NULL,NULL,0),(13,9,'苏州任云人力资源有限公司','公司简介','法人','dgfd','regergerg','苏州任天疼','cvbju','gdfgdfg',NULL,2,0,'2019-08-23 01:54:11','2019-08-27 22:20:41',NULL,'10-250','公有制',NULL,NULL,0,0),(14,9,'喵喵天公司','公司简介','喵星人','123','漕宝路','龙泉大道','营业执照e',NULL,NULL,2,0,'2019-08-23 02:01:32','2019-08-27 22:20:41',13,'100-200','股份制',NULL,NULL,NULL,0);
...
CREATE TABLE `hr_rebaterecord` (
  ...
  `RebateMale` decimal(10,0) DEFAULT '0' COMMENT '返佣金额男',
  `RebateFemale` decimal(10,0) DEFAULT '0' COMMENT '返佣金额女',
  `RebateTime` date DEFAULT NULL COMMENT '返佣时间',
  `status` int(11) DEFAULT '0' COMMENT '1给付已结束(已返佣) 2给付失败(不返佣) 3给付中(返佣中) 4返佣失败',
...
INSERT INTO `hr_rebaterecord` VALUES (1,6,0,200,0,'2019-07-04',0,0,'2019-01-19 05:45:57',0,6),(2,1,0,1,0,'2019-02-04',2,0,'2019-01-19 05:47:13',17200,2),(3,2,1,0,788,'2018-07-13',0,0,'2019-07-23 04:47:13',3029,1),(4,2,2,233,0,'2018-07-27',2,0,'2019-08-19 05:47:13',3029,4),(5,3,0,0,200,'2019-08-21',1,0,'2019-02-19 06:04:39',155,5),(6,3,1,400,0,'2019-08-21',2,0,'2019-07-24 06:04:39',0,3),(7,3,2,0,300,'2019-08-21',1,0,'2019-08-26 06:04:39',0,6),(8,4,0,100,200,'2019-07-21',2,0,'2019-01-23 06:05:31',0,8),(9,4,2,150,230,'2019-07-28',0,0,'2019-08-25 06:05:31',0,15),(10,4,1,200,139,'2019-07-24',1,0,'2019-07-20 06:05:32',0,16),(11,5,2,0,400,'2018-10-11',1,0,'2019-08-25 08:33:53',0,3),(12,5,1,0,150,'2019-08-21',1,0,'2019-07-24 08:33:54',0,16),(13,6,1,200,0,'2019-07-22',1,0,'2019-07-26 01:40:04',0,9),(14,6,2,400,600,'2019-07-15',1,0,'2019-07-25 03:22:32',0,8),(15,7,0,100,200,'2019-08-21',0,0,'2019-08-23 03:02:38',0,9),(16,7,1,150,230,'2019-08-21',0,0,'2019-08-23 03:02:39',0,10),(17,7,2,200,139,'2019-08-21',0,0,'2019-08-23 03:02:39',0,14),(18,2,1,0,343,'2019-08-26',0,0,'2019-08-26 02:19:56',0,2);
...
CREATE TABLE `hr_signup_deliveryrecord` (
  ...
  `brief_chapter_id` int(11) DEFAULT NULL COMMENT '简章Id',
  `job_status` int(11) DEFAULT NULL COMMENT '求职状态 0已报名 1报名未通过 2待面试 3未面试 4面试未通过 5待报道 6未报道 7待返佣 8返佣完成',
...
CREATE TABLE `hr_user` (
  ...
  `PostIdStr` varchar(32) DEFAULT NULL COMMENT '意向岗位 可以为多个岗位id',
  `Mobile` varchar(32) DEFAULT NULL COMMENT '手机号',
  `IdCard` varchar(32) DEFAULT NULL COMMENT '身份证',
  `education` varchar(255) DEFAULT NULL COMMENT '学历',
  `profession` varchar(255) DEFAULT NULL COMMENT '专业',
  `graduationTime` date DEFAULT NULL COMMENT '毕业时间',
  `arrivalTime` date DEFAULT NULL COMMENT '到岗时间',
  `expectedSalaryLower` decimal(10,0) DEFAULT NULL COMMENT '期望薪资下限',
  `expectedSalaryUpper` decimal(10,0) DEFAULT NULL COMMENT '期望薪资上限',
...
INSERT INTO `my_sign_up_table` VALUES (1,'公开',0,'2019-07-08 00:00:00',0,NULL),(4,'不公开',1,'2019-07-22 08:17:18',0,NULL),(5,'平台帮助',2,'2019-07-22 08:20:03',0,NULL),(6,'商家协助',3,'2019-07-22 08:23:52',0,3),(10,'aa分组',3,'2019-07-22 09:05:09',0,2),(11,'分组6',3,'2019-07-22 09:05:42',0,3),(12,'重要的分组',3,'2019-08-08 07:21:28',0,2),(15,'可爱的分组',3,'2019-08-08 08:36:21',0,2),(16,'分组1',3,'2019-08-08 09:12:00',0,3);
/*!40000 ALTER TABLE `my_sign_up_table` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `my_sign_up_table_sign_up`
--

DROP TABLE IF EXISTS `my_sign_up_table_sign_up`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `my_sign_up_table_sign_up` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `my_sign_up_table_id` int(11) DEFAULT NULL COMMENT '我的求职表主键id',
  `sign_up_id` int(11) DEFAULT NULL COMMENT '报名表主键id',
  `delete_time` int(11) DEFAULT '0' COMMENT '0 未删除 1 已删除',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='我的求职表和报名表的中间表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `my_sign_up_table_sign_up`
--
...
INSERT INTO `test` VALUES ('2019-08-29 18:38:52',1);
...
-- Dump completed on 2019-08-29 18:39:00
