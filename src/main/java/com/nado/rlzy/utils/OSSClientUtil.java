...
public class OSSClientUtil {
     ...
     * accessKey
     */
    private String accessKeyId = "LTAIZsSbp7m4iEeZ";


    private String accessKeySecret = "0NBtaTcOOwBtuFWMCu9tOYMiWVMyLN";
    /**
     * 空间
     */
    private String bucketName = "tongzhe-oss";
    /**
     * 文件存储目录
     */
